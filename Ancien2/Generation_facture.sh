...
if [$prenomclient=""];
then pdfname=Facture_$nomouSocieteduclient.pdf
else pdfname=Facture_$nomouSocieteduclient$prenomclient.pdf
fi
...
rm Facture_template.log;
rm Facture_template.aux;
rm Facture_template.dvi;
